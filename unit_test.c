...
START_TEST(test_s21_add_8) {
    s21_decimal test_value_1 = {{4294967295, 4294967295, 4294967295, 0}};
    s21_decimal test_value_2 = {{1, 1, 1, 0}};
    s21_set_bit(&test_value_1.bits[3], 31, 1);
    s21_set_bit(&test_value_2.bits[3], 31, 1);
    s21_decimal result_dec = {{0, 0, 0, 0}};
    int result = s21_add(test_value_1, test_value_2, &result_dec);
...
START_TEST(test_s21_add_10) {
    ...
    s21_decimal result_dec = {{0, 0, 0, 0}};
    s21_add(test_value_1, test_value_2, &result_dec);
    ck_assert_uint_eq(result_dec.bits[0], 2576980378);
    ck_assert_uint_eq(result_dec.bits[1], 2576980377);
    ck_assert_uint_eq(result_dec.bits[2], 429496729);
...
START_TEST(test_s21_add_25) {
    ...
    ck_assert_int_eq(result_dec.bits[2], 4294967290);
    ck_assert_int_eq(result_dec.bits[3], 0);
}
END_TEST
...
START_TEST(test_s21_sub_8) {
    ...
    ck_assert_uint_eq(result_dec.bits[0], 4294962296);
...
START_TEST(test_s21_sub_9) {
    ...
    s21_sub(test_value_1, test_value_2, &result_dec);
    ck_assert_uint_eq(result_dec.bits[0], 4294962296);
    ck_assert_uint_eq(result_dec.bits[1], 4294967293);
...
START_TEST(test_s21_sub_10) {
    ...
    s21_sub(test_value_1, test_value_2, &result_dec);
    ck_assert_uint_eq(result_dec.bits[0], 4294962296);
    ck_assert_uint_eq(result_dec.bits[1], 4294967289);
    ck_assert_uint_eq(result_dec.bits[2], 4);
}
END_TEST
...
START_TEST(test_s21_mul_9) {
    ...
    s21_mul(src1, src2, &result);
    ck_assert_int_eq(result.bits[0], 927712936);
...
START_TEST(test_s21_is_less_1) {
    ...
    ck_assert_int_eq(s21_is_less(test_value_1, test_value_2), 1);  // 10 < 15 = True
}
END_TEST
...
START_TEST(test_s21_is_less_2) {
    ...
    ck_assert_int_eq(s21_is_less(test_value_1, test_value_2), 1);  // 6739 < 19993 = True
}
END_TEST
...
START_TEST(test_s21_is_less_3) {
    ...
    ck_assert_int_eq(s21_is_less(test_value_1, test_value_2), 0);  // 19993 < 6739 = False
}
END_TEST
...
START_TEST(test_s21_is_less_5) {
    s21_decimal test_value_1 = {{19993, 0, 0, 0}};
    s21_decimal test_value_2 = {{19993, 0, 0, 0}};
    ck_assert_int_eq(s21_is_less(test_value_1, test_value_2), 0);  // 19993 < 19993 = False
}
END_TEST
...
START_TEST(test_s21_is_less_6) {
    ...
    ck_assert_int_eq(s21_is_less(test_value_1, test_value_2), 0);  // 19993 < 199,93 = False
}
END_TEST

START_TEST(test_s21_is_less_7) {
    s21_decimal test_value_1 = {{0, 1, 0, 0}};
    s21_decimal test_value_2 = {{19993, 0, 0, }};
    ck_assert_int_eq(s21_is_less(test_value_1, test_value_2), 0);  // 4294967295 < 19993 = False
}
END_TEST
...
START_TEST(test_s21_is_less_8) {
    ...
    s21_decimal test_value_2 = {{19993, 0, 0, 0}};
    ck_assert_int_eq(s21_is_less(test_value_1, test_value_2), 1);  // -19993 < 19993 = True
}
END_TEST
...
START_TEST(test_s21_is_less_or_equal_1) {
    s21_decimal test_value_1 = {{0, 0, 0, 0}};
    s21_decimal test_value_2 = {{0, 0, 0, 0}};
    ck_assert_int_eq(s21_is_less_or_equal(test_value_1, test_value_2), 1);  // 0 <= 0 = True
}
END_TEST
...
START_TEST(test_s21_is_less_or_equal_2) {
    ...
    ck_assert_int_eq(s21_is_less_or_equal(test_value_1, test_value_2), 1);  // 5000 <= 5001 = True
}
END_TEST
...
START_TEST(test_s21_is_less_or_equal_3) {
    ...
    ck_assert_int_eq(s21_is_less_or_equal(test_value_1, test_value_2), 0);  // 5000 <= -5000 = False
}
END_TEST
...
START_TEST(test_s21_is_less_or_equal_4) {
    ...
    ck_assert_int_eq(s21_is_less_or_equal(test_value_1, test_value_2), 0);  // 5000 <= 50 = False
}
END_TEST
...
START_TEST(test_s21_is_less_or_equal_5) {
    ...
    ck_assert_int_eq(s21_is_less_or_equal(test_value_1, test_value_2), 1);  // 4294967295 <= 4294967295 = True
}
END_TEST
...
START_TEST(test_s21_is_greater_or_equal_1) {
    s21_decimal test_value_1 = {{0, 0, 0, 0}};
    s21_decimal test_value_2 = {{0, 0, 0, 0}};
    ck_assert_int_eq(s21_is_greater_or_equal(test_value_1, test_value_2), 1);  // 0 >= 0 = True
}
END_TEST
...
START_TEST(test_s21_is_greater_or_equal_2) {
    s21_decimal test_value_1 = {{5000, 0, 0, 0}};
    s21_decimal test_value_2 = {{5001, 0, 0, 0}};
    ck_assert_int_eq(s21_is_greater_or_equal(test_value_1, test_value_2), 0);  // 5000 >= 5001 = False
}
END_TEST
...
START_TEST(test_s21_is_greater_or_equal_3) {
    s21_decimal test_value_1 = {{5000, 0, 0, 0}};
    s21_decimal test_value_2 = {{5000, 0, 0, 131072}};
    ck_assert_int_eq(s21_is_greater_or_equal(test_value_1, test_value_2), 1);  // 5000 >= 50 = True
}
END_TEST
...
START_TEST(test_s21_is_greater_or_equal_4) {
    s21_decimal test_value_1 = {{5000, 0, 0, 0}};
    s21_decimal test_value_2 = {{5000, 0, 0, 2147483648}};
    ck_assert_int_eq(s21_is_greater_or_equal(test_value_1, test_value_2), 1);  // 5000 >= -5000 = True
}
END_TEST
...
START_TEST(test_s21_is_equal_1) {
    s21_decimal test_value_1 = {{0, 0, 0, 0}};
    s21_decimal test_value_2 = {{0, 0, 0, 0}};
    ck_assert_int_eq(s21_is_equal(test_value_1, test_value_2), 1);  // 0 == 0 = True
}
END_TEST
...
START_TEST(test_s21_is_equal_2) {
    s21_decimal test_value_1 = {{5000, 0, 0, 0}};
    s21_decimal test_value_2 = {{5001, 0, 0, 0}};
    ck_assert_int_eq(s21_is_equal(test_value_1, test_value_2), 0);  // 5000 == 5001 = False
}
END_TEST
...
START_TEST(test_s21_is_equal_3) {
    s21_decimal test_value_1 = {{5000, 0, 0, 0}};
    s21_decimal test_value_2 = {{5000, 0, 0, 2147483648}};
    ck_assert_int_eq(s21_is_equal(test_value_1, test_value_2), 0);  // 5000 == -5000 = False
}
END_TEST
...
START_TEST(test_s21_is_equal_4) {
    s21_decimal test_value_1 = {{5000, 0, 0, 0}};
    s21_decimal test_value_2 = {{5000, 0, 0, 131072}};
    ck_assert_int_eq(s21_is_equal(test_value_1, test_value_2), 0);  // 5000 == 50 = False
}
END_TEST
...
START_TEST(test_s21_is_equal_5) {
    ...
    ck_assert_int_eq(s21_is_equal(test_value_1, test_value_2), 0);  // number1 == number2 = False
}
END_TEST
...
START_TEST(test_s21_is_not_equal_1) {
    s21_decimal test_value_1 = {{0, 0, 0, 0}};
    s21_decimal test_value_2 = {{0, 0, 0, 0}};
    ck_assert_int_eq(s21_is_not_equal(test_value_1, test_value_2), 0);  // 0 != 0 = False
}
END_TEST
...
START_TEST(test_s21_is_not_equal_2) {
    s21_decimal test_value_1 = {{5000, 0, 0, 0}};
    s21_decimal test_value_2 = {{5001, 0, 0, 0}};
    ck_assert_int_eq(s21_is_not_equal(test_value_1, test_value_2), 1);  // 5000 != 5001 = True
}
END_TEST
...
START_TEST(test_s21_is_not_equal_3) {
    s21_decimal test_value_1 = {{5000, 0, 0, 0}};
    s21_decimal test_value_2 = {{5000, 0, 0, 2147483648}};
    ck_assert_int_eq(s21_is_not_equal(test_value_1, test_value_2), 1);  // 5000 != -5000 = True
}
END_TEST
...
START_TEST(test_s21_is_not_equal_4) {
    s21_decimal test_value_1 = {{5000, 0, 0, 0}};
    s21_decimal test_value_2 = {{5000, 0, 0, 131072}};
    ck_assert_int_eq(s21_is_not_equal(test_value_1, test_value_2), 1);  // 5000 != 50 = True
}
END_TEST
...
START_TEST(test_s21_is_not_equal_5) {
    s21_decimal test_value_1 = {{5000, 1, 0, 0}};
    s21_decimal test_value_2 = {{5000, 0, 2, 0}};
    ck_assert_int_eq(s21_is_not_equal(test_value_1, test_value_2), 1);  // number1 != number2 = True
}
END_TEST
...
START_TEST(test_s21_form_float_to_decimal_3) {
    ...
    ck_assert_int_eq(result.bits[0], 12802299);
    ck_assert_int_eq(result.bits[1], 0);
    ck_assert_int_eq(result.bits[2], 0);
